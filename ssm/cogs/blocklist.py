...
from ssm.base import db_manager, use_language
from ssm.main import embed_send, bot_prefix
from ssm.modules.language_manager import LanguageManager
from ssm.sql.models.basic import Reactions
from ssm.sql.models.blocklist import BlocklistServer, BlocklistSettings, BlocklistUser

logger = getLogger('main').getChild('blocklist')

language = LanguageManager(base_path='./ssm/language/', lang=f'{use_language}', module_name='blocklist').get()
