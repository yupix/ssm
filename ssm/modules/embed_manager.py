...
class EmbedManager:
    ...
    async def generate(self, embed_title: str = None, embed_description: str = None, mode: str = None, embed_color: int = 0x8bc34a, embed_content: list = None, embed_image: str = None,
        ...
        if embed_image is not None:
            embed.set_image(url=f'{embed_image}')
